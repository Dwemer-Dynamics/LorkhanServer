...
TMP=$(mktemp -d "${TMPDIR:-/tmp}/almsivi-jobs-pg.XXXXXX")
PORT=${ALMSIVI_JOBS_TEST_PORT:-55440}
...
createdb -h 127.0.0.1 -p "$PORT" almsivi_jobs_test
ALMSIVI_TEST_DSN="pgsql:host=127.0.0.1;port=$PORT;dbname=almsivi_jobs_test" \
