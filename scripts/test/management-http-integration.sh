...
psql -h 127.0.0.1 -p "$PG_PORT" -d almsivi_management_http -v ON_ERROR_STOP=1 -c "INSERT INTO installations(installation_id,token_fingerprint) VALUES ('00000000-0000-4000-8000-000000000001','$TOKEN_HASH')" >/dev/null
