...
core_values['core_settings_overrides_json']=json.dumps({'memory':{'oghma_knowledge_tags':'Morrowind,Tribunal'},'response':{'max_words':999},'oghma':{'enabled':False,'result_limit':1},'context':{'prompt_timestamp':True,'ground_items_descriptions_only':False,'inventory_items_descriptions_only':True},'prompt':{'prompt_head':'Core HTTP prompt.'},'behavior':{'rechat_mode':'group'},'relationship':{'enabled':False}})
...
assert core_advanced['behavior']['rechat_mode']=='group' and core_advanced['relationship']=={'enabled':False}
