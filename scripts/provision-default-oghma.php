...
try{
    ...
    if(!is_dir($directory)){echo json_encode(['schema'=>'almsivi.default-oghma.v1','status'=>'skipped','reason'=>'current_dataset_not_bundled'],JSON_THROW_ON_ERROR).PHP_EOL;exit(0);}
    ...
    echo json_encode(['schema'=>'almsivi.default-oghma.v3','status'=>$planOnly?'planned':'ready','current_dataset_version'=>$version,'result'=>$result],JSON_THROW_ON_ERROR|JSON_UNESCAPED_SLASHES).PHP_EOL;
