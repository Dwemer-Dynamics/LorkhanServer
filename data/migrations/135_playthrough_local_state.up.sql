-- Installation-wide gameplay views are staged with an inactive copy, then restored at admission.
CREATE TABLE lorkhan_internal.playthrough_local_state (
    playthrough_id uuid PRIMARY KEY REFERENCES lorkhan_internal.playthroughs ON DELETE CASCADE,
