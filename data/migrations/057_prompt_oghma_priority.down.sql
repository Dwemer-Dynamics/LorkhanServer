UPDATE lorkhan_internal.retrieval_traces
SET prompt_section='morrowind_context'
WHERE prompt_section='oghma_context';

DELETE FROM lorkhan_internal.prompt_trace_sections
WHERE section_key='oghma_context'
  AND prompt_trace_id IN (
      SELECT prompt_trace_id FROM lorkhan_internal.prompt_traces
...
UPDATE lorkhan_internal.prompt_trace_sections
...
UPDATE lorkhan_internal.prompt_trace_sources
...
UPDATE lorkhan_internal.prompt_traces
