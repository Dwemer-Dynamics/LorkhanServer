...
$contextGroups = require __DIR__.'/tmpl/context_selection_groups.php';
$llmOptions = ['' => 'Disabled'];
...
$sections = [
    ...
    'context-knowledge' => [
        // CHIM's Oghma catalog order; fallback enablement is paired with its connector.
        'Oghma' => [
            ['oghma_enabled', 'Enable Oghma', '&#x1F4DA;', 'boolean', $oghmaSettings['enabled'], 'Add relevant lore to response context.', []],
            ['oghma_topic_count', 'Oghma Topic Count', '&#x1F4DA;', 'select', $oghmaSettings['topic_count'], 'Maximum topics extracted for each request.', ['values' => ['1','2','3']]],
            ['oghma_result_limit', 'Oghma Result Limit', '&#x1F4D1;', 'select', $oghmaSettings['result_limit'], 'Maximum Oghma articles included in one prompt.', ['values' => ['1','2','3','4','5']]],
            ['oghma_racial_context_enabled', 'Force Racial Oghma', '&#x1F9DD;', 'boolean', $oghmaSettings['racial_context_enabled'], 'Always include matching race lore when available.', []],
            ['oghma_location_context_enabled', 'Force Location Oghma', '&#x1F5FA;&#xFE0F;', 'boolean', $oghmaSettings['location_context_enabled'], 'Always include matching location lore when available.', []],
            ['oghma_configuration_id', 'Oghma Extractor Fallback', '&#x1F4D6;', 'select', $systemRouting['oghma_configuration_id'], 'Allow one bounded connector fallback after deterministic Oghma abstains.', ['values'=>$llmOptions, 'toggle'=>['oghma_extractor_enabled','Oghma Extractor Fallback',$oghmaSettings['extractor_enabled']]]],
