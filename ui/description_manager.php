...
<div class="description-modal" id="description-editor" aria-hidden="true"><div class="modal-container" role="dialog" aria-modal="true" aria-labelledby="description-editor-title">
    ...
    <div class="modal-body"><form method="post" action="<?php echo lorkhan_ui_h($managementBasePath.'/forms/description-save'); ?>" id="description-editor-form">
        ...
        <label for="description-name">Name:</label><small id="description-name-help">Display name for this item. Required by the Lorkhan description catalog.</small><input type="text" id="description-name" name="display_name" maxlength="256" aria-describedby="description-name-help" required>
        <label for="description-text">Description:</label><small id="description-text-help">Short description to be injected into AI context.</small><textarea id="description-text" name="description" maxlength="8192" rows="6" aria-describedby="description-text-help" required></textarea>
