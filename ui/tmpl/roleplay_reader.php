...
function lorkhan_roleplay_reader_state(PDO $database, array $installationOptions, string $tab): array
{
    ...
    $extra = match ($tab) { 'responselog' => ',n.turn_id,n.request_id,n.prompt_messages,n.input_kind,n.input_text,n.turn_seconds,n.prompt_driver,n.prompt_model', 'adventure' => ',n.location,n.gamets,n.calendar_data', 'diaries' => ',n.calendar_data', 'books','journal' => ',n.calendar_data,n.ts', default => '' };
