...
<?php require_once __DIR__.'/tmpl/tts_filter_field.php'; lorkhan_ui_tts_filter_field($content,(string)($profile['profile_id']??''),$managementBasePath,$csrf); ?>
                ...
                <section class="narrator-content-section narrator-full-width">
                    ...
                    <div class="narrator-dynamic-profile-card">
                        ...
                        <?php require_once __DIR__.'/tmpl/dynamic_profile_schedule.php'; lorkhan_dynamic_profile_schedule($content['settings_overrides']['profile_evolution']??[],'evolution_',true); ?>
