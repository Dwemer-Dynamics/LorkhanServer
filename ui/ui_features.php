...
function lorkhan_ui_feature_registry(): array
{
    static $features = [
        ...
        'config.profiles.import' => ['title' => 'Import Profile', 'state' => 'live', 'description' => 'Imports a Lorkhan profile export with its saved prompt, settings and referenced connectors. Optionally assigns the default profile, current default NPCs and a quick slot. New connectors need local credentials.'],
        ...
        'config.profiles.export' => ['title' => 'Export Profile', 'state' => 'live', 'description' => 'Downloads the saved profile, prompt and referenced connectors. API keys, credential assignments, revision history and NPC assignments are not exported.'],
        ...
        'config.profiles.dynamic-profile' => ['title' => 'Dynamic Profile', 'state' => 'live', 'description' => 'Unlocked known NPC profiles evolve selected fields after the configured game-day interval, delivered event count and real-time cooldown.'],
        ...
        'config.narrator.dynamic-profile' => ['title' => 'Dynamic Profile Updates', 'state' => 'live', 'description' => 'The unlocked narrator evolves selected fields after the configured game-day interval, delivered event count and real-time cooldown.'],
        ...
        'config.llm.json-schema' => ['title' => 'JSON Schema and Prefill', 'state' => 'live', 'description' => 'Optional operation-specific JSON Schema and assistant continuation work across dialogue and generation providers, with strict response validation retained.'],
        ...
        'config.llm.body-parameters' => ['title' => 'Request Body Parameters', 'state' => 'live', 'description' => 'The YAML editor stores optional bounded request-body parameters with a separate enable switch. Native messages, delivery, actions and credentials remain protected.'],
        ...
        'config.stt.google-free' => ['title' => 'Google Free STT', 'state' => 'live', 'description' => 'Chrome recognition sends bounded text to a compatible game session through the authenticated command queue. Game acceptance is shown separately from queueing; session changes, expired commands and busy input are rejected.'],
