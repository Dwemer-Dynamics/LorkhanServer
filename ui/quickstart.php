...
<main class="quickstart-page"><div class="qs-shell">
    ...
    <form class="confwizard" method="post" action="<?php echo lorkhan_ui_h($managementBasePath); ?>/forms/quickstart-save" data-track-dirty>
        ...
        <div class="qs-actions"><span data-dirty-indicator hidden>Unsaved changes</span><button type="submit" class="btn-primary qs-save-btn"<?php echo !$ready?' disabled':''; ?>>Save and Continue</button></div>
    </form>
</div></main>
