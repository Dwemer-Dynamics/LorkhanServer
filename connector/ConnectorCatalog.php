...
final class ConnectorCatalog
{
    ...
    private const TTS = [
        ...
        'xtts-fastapi' => ['XTTS', true, 'LORKHAN_TTS_XTTS_API_KEY'],
        'xtts' => ['XTTS (legacy API)', true, 'LORKHAN_TTS_XTTS_API_KEY'],
    ...
    private const TTS_DEFAULTS = [
        ...
        'zonos_gradio'=>['http://127.0.0.1:7860','Zyphra/Zonos-v0.1-hybrid','default','en-us'],
    ];
