...
CREATE TABLE almsivi_internal.relationship_conversion_results (
    job_id uuid PRIMARY KEY REFERENCES almsivi_internal.durable_jobs(job_id),
    batch_request_id uuid NOT NULL,
    owner_profile_id uuid NOT NULL REFERENCES almsivi_internal.profiles(profile_id),
...
CREATE INDEX relationship_conversion_batch_order ON almsivi_internal.durable_jobs
