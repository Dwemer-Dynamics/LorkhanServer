DROP TRIGGER IF EXISTS memory_record_initial_revision_capture ON lorkhan_internal.memory_records;
DROP FUNCTION IF EXISTS lorkhan_internal.capture_memory_record_initial_revision();
DROP TRIGGER IF EXISTS memory_record_revision_capture ON lorkhan_internal.memory_records;
DROP FUNCTION IF EXISTS lorkhan_internal.capture_memory_record_revision();
DROP TABLE IF EXISTS lorkhan_internal.memory_record_revisions;
ALTER TABLE lorkhan_internal.memory_records DROP COLUMN IF EXISTS current_revision;
...
DROP TABLE IF EXISTS lorkhan_internal.prompt_trace_sections;
