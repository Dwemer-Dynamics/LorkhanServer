...
CREATE TABLE almsivi_internal.profile_assignment_rules (
    ...
    FOREIGN KEY (core_profile_id,installation_id)
        REFERENCES almsivi_internal.core_profiles(core_profile_id,installation_id)
);

CREATE INDEX profile_assignment_rules_runtime
    ON almsivi_internal.profile_assignment_rules
