...
CREATE UNIQUE INDEX turns_response_id_unique ON lorkhan_internal.turns(response_id) WHERE response_id IS NOT NULL;
...
UPDATE lorkhan_internal.dialogue_utterances
