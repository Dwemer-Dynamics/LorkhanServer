DROP TRIGGER IF EXISTS turns_openmw_record_identity ON almsivi_internal.turns;
...
DROP FUNCTION IF EXISTS almsivi_internal.sync_openmw_record_identity();
DROP FUNCTION IF EXISTS almsivi_internal.observe_openmw_item(uuid,uuid,uuid,timestamptz,text,jsonb);
DROP TABLE IF EXISTS almsivi_internal.discovered_items;
DROP TABLE IF EXISTS almsivi_internal.content_manifest_files;
DROP TABLE IF EXISTS almsivi_internal.content_manifests;
