...
final class FirstPartyJobHandlerFactory
{
        ...
        ?TranslationProvider $translationProvider = null): array
    {
        ...
        return array_merge($handlers, [
            new DirectorPlanJobHandler(new \LorkhanServer\Infrastructure\DirectorPlanningRepository($db),
                new \LorkhanServer\Infrastructure\DirectorRoutingRepository($db),$products,
            ...
            new MemoryDigestScanJobHandler(new \LorkhanServer\Infrastructure\NpcMemoryDigestRepository($db)),
            new MemoryDigestJobHandler(new \LorkhanServer\Infrastructure\NpcMemoryDigestRepository($db),$products,
                new \LorkhanServer\Infrastructure\ProviderAttemptRepository($db),$providerConfig),
    ...
    public static function jobTypes(): array
    {
        return [
            ...
            MemoryDigestJobHandler::TYPE,
            MemoryDigestScanJobHandler::TYPE,
            ...
            DatabaseReplayJobHandler::TYPE, DatabaseFactoryResetJobHandler::TYPE,
