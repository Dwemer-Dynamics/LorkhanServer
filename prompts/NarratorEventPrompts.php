...
final class NarratorEventPrompts
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'player_speech_style_prompt' => ['description' => 'Generate player speech style from recorded dialogue and optional guidance. Supports {PLAYER_NAME}, {PLAYER_GUIDANCE}, {CURRENT_SPEECH_STYLE} and {DIALOGUE_SAMPLES}.',
