...
function almsivi_ui_feature_registry(): array
{
    static $features = [
        ...
        'autonomy' => ['title' => 'Autonomy', 'state' => 'excluded', 'description' => 'Automatic greetings, rechat, boredom events, combat barks, schedules, and other model-triggering autonomy are excluded from this milestone.'],
        ...
        'config.globals.strict-rechat' => ['title' => 'Strict Rechat Targeting', 'state' => 'excluded', 'description' => 'Strict previous-speaker targeting is autonomy and is excluded from this milestone.'],
        ...
        'config.globals.conversation-cooldown' => ['title' => 'End Conversation Cooldown', 'state' => 'excluded', 'description' => 'Automatic post-conversation responder scheduling is autonomy and is excluded from this milestone.'],
