...
function almsivi_ui_feature_registry(): array
{
    static $features = [
        ...
        'config.npc.inherited-filter' => ['title' => 'Inherited NPC Filter', 'state' => 'planned', 'description' => 'Filtering resolved Global and Core Profile values requires a future typed repository query.'],
        ...
        'config.profiles.dynamic-profile' => ['title' => 'Dynamic Profile', 'state' => 'planned', 'description' => 'Automatic profile evolution is not connected to the bounded OpenMW event pipeline.'],
        ...
        'config.player.autochat-tts' => ['title' => 'Player Autochat and TTS', 'state' => 'planned', 'description' => 'Player re-speech routing and per-player voice overrides are not connected to the current OpenMW client.'],
        ...
        'config.narrator.event-tuning' => ['title' => 'Narration Event Tuning', 'state' => 'planned', 'description' => 'Per-event chance and cooldown tuning requires additional typed OpenMW settings.'],
        'config.narrator.bored-events' => ['title' => 'Narrator Bored Events', 'state' => 'planned', 'description' => 'Bored-event narrator routing is not connected to the current typed event pipeline.'],
        ...
        'config.narrator.dynamic-profile' => ['title' => 'Dynamic Profile Updates', 'state' => 'planned', 'description' => 'Automatic narrator profile evolution is not connected to an OpenMW client capability.'],
        ...
        'config.stt' => ['title' => 'STT', 'state' => 'excluded', 'description' => 'Speech-to-text is intentionally excluded from the current ALMSIVI scope.', 'controls' => ['Create STT Connector', 'Import Connector', 'Test Connection']],
        ...
        'config.globals.rechat-mode' => ['title' => 'Rechat Mode', 'state' => 'planned', 'description' => 'Per-chain tight, conversational, group, and random responder modes are not represented in the typed rechat policy yet.'],
        'config.globals.strict-rechat' => ['title' => 'Strict Rechat Targeting', 'state' => 'planned', 'description' => 'Strict previous-speaker targeting requires an additional typed OpenMW rechat policy.'],
        ...
        'roleplay.relationships' => ['title' => 'Relationships', 'state' => 'live', 'description' => 'Audited actor relationship state.'],
        ...
        'roleplay.quests' => ['title' => 'Active Quests', 'state' => 'planned', 'description' => 'OpenMW quest context is reserved for a future typed client capability.', 'controls' => ['Refresh Quests', 'View Quest Details']],
