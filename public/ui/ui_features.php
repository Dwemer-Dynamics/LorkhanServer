...
function almsivi_ui_feature_registry(): array
{
    static $features = [
        ...
        'config.profiles.formatter-llm' => ['title' => 'Formatter LLM', 'state' => 'not-applicable', 'description' => 'The Herika Formatter LLM field is audit-only and its active runtime never calls it, so ALMSIVI records no formatter connector.'],
        ...
        'config.keys.deepl' => ['title' => 'DeepL Credential', 'state' => 'live', 'description' => 'ALMSIVI_DEEPL_API_KEY is the server-held key used by NPC output translation. The value stays in the ALMSIVI credential store and is never displayed, serialized, or exported.'],
