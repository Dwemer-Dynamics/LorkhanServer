...
function lorkhan_ui_feature_registry(): array
{
    static $features = [
        ...
        'config.profiles.diary-llm' => ['title' => 'Diary LLM', 'state' => 'live', 'description' => 'Each Core Profile can select one diary model for its assigned NPCs. A change applies to newly queued manual diary jobs only; queued jobs keep their frozen connector revision, saving a profile never calls a provider, and automatic diary generation stays excluded.'],
        ...
        'config.player.autochat-tts' => ['title' => 'Player Autochat and TTS', 'state' => 'partial', 'description' => 'Typed player messages can use a profile-routed TTS connector; autonomous player chat remains excluded.'],
        ...
        'config.globals.export' => ['title' => 'Export Global Settings', 'state' => 'live', 'description' => 'Downloads one complete portable Global Settings document, including system connector references but excluding installation identity, revision history, API keys, Core Profiles, NPC profiles, and assignments.'],
        'config.globals.import' => ['title' => 'Import Global Settings', 'state' => 'live', 'description' => 'Applies one complete portable Global Settings document as a new revision. Legacy v1 presets preserve the local translation, Oghma, Auto Lock Profile, and system connector settings they did not carry.'],
