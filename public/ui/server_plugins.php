...
$pageTitle='Server Plugins';$topNavSection='configuration';$bodyClass='configuration-resource view-server-plugins';
...
<main class="management-page">
    <header class="configuration-page-header"><h1>Server Plugins</h1><p>Installed ALMSIVI server modules are source-controlled and registered through fixed factories. Arbitrary PHP upload and execution is disabled.</p></header>
