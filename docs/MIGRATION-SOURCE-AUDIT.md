...
| Synthserver/Fallout concept | ALMSIVIserver concept |
| --- | --- |
| SYNTH/Synthserver | ALMSIVI/ALMSIVIserver |
...
- **Replace runtime assumptions:** F4SE/VR discovery, INI/DLL/package/ESP, NDJSON if final SYNTH uses it
  incompatibly with ALMSIVI long polling, and Fallout media/identity details.
...
clean database unless the user explicitly supplies ALMSIVI data to migrate.
