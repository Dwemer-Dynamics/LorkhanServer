...
| Timer autonomy, boredom, greetings, combat barks, ITT, STT and Background Life/automatic diary systems | Explicitly excluded from the requested ALMSIVI scope. Playback-driven rechat and manual narrator/diary/summary records remain available. |
