...
| Events/traces | Search/detail scoped CHIM-style `eventlog`, `speech`, `responselog`, revisioned `prompts`, turns, prompt/provider attempts, response/action/result, and rechat-chain state. |
