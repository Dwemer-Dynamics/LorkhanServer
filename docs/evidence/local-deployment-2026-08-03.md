...
| Full local WSL deployment | PASS - active tree `/var/www/html/LorkhanServer`; persistent database, media, logs, and secrets preserved |
| Runtime health | PASS - `lorkhan.health.v1`, Apache running, worker loop and PHP worker use the active tree |
