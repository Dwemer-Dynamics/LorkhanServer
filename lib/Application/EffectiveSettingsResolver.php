...
final class EffectiveSettingsResolver
{
    ...
    private static function validateContextPolicy(mixed $context): array
    {
        ...
        $context += ['prompt_timestamp' => false, 'ground_items_descriptions_only' => false];
        self::assertExactKeys($context, $expected, 'invalid_global_settings');
        if (!is_bool($context['prompt_timestamp']) || !is_bool($context['ground_items_descriptions_only'])) throw new InvalidArgumentException('invalid_global_settings');
