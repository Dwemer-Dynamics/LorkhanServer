...
final class SettingsCatalog
{
    ...
    private const SYSTEM_ROUTING_FIELDS = [
        'oghma_configuration_id', 'profile_generation_configuration_id', 'relationship_configuration_id', 'background_memory_configuration_id', 'scene_classifier_configuration_id', 'director_configuration_id',
    ];
