...
final class SettingsCatalog
{
    ...
    public static function npcOverrideFields(): array
    {
        return [
            ...
            'context' => ['prompt_timestamp','ground_items_descriptions_only','inventory_items_descriptions_only','power_awareness_enabled','transformation_detection','short_term_in_compact_chat','hide_ambient_combat','location_blacklist','item_blacklist','magic_effects_blacklist','event_types','sections','details'],
            'prompt' => ['prompt_head','emote_moods'],
