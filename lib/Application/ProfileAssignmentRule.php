...
final class ProfileAssignmentRule
{
    ...
    public const METADATA_FIELDS = [
        ...
        'AUTO_DIARY_ENABLED'=>['diary','automatic_enabled','boolean'],
        'AUTO_DIARY_WAIT_ENABLED'=>['diary','automatic_wait_enabled','boolean'],
        'MATERIALIZE_DIARY_ENABLED'=>['diary','materialize_enabled','boolean'],
        ...
        'DETECT_MAGIC_EVENT'=>['context','detect_magic_events','boolean'],
        'CHIM_ITEM_PICKUP_EVENTLOG_MIN_VALUE'=>['context','item_pickup_min_value','integer'],
        'LOCATION_BLACKLIST'=>['context','location_blacklist','list'],
        'ITEM_BLACKLIST'=>['context','item_blacklist','list'],
        'MAGIC_EVENT_BLACKLIST'=>['context','magic_effects_blacklist','list'],
